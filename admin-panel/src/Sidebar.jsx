...
import NoOfOrder from './components/NoOfOrder.jsx'
// import Sales from './components/SalesSummary.jsx'
import NoOfCustomer from './components/NoOfCustomer.jsx'
...
const menuItems = [
  {
    ...
    icon: <InboxIcon />,
    subMenu: [
      { text: 'Sales summary', component: () => <div></div> },
      { text: 'Total revenue', component: () => <div>Total revenue component</div> },
      { text: 'Number of orders', component: () => <div><NoOfOrder/></div> },
...
export default function Sidebar() {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      <CssBaseline />
      <AppBar position="fixed" open={open} sx={{backgroundColor:'maroon'}}>
        <Toolbar>
          <IconButton
            color="inherit"
